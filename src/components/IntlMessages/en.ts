export default {
  ...
  more: {
    ...
    author: {
      ...
      me: {
        title: 'Krishnan S',
        description: 'IT UnderGrad at CEG, Anna University'
      },
      contactMe: {
        title: 'Contact me',
  ...
  dates: {
    ...
    releasedTomorrow: 'Come out tomorrow',
    released: 'Released on {date}',
    coming: 'Coming on {date}'
  },
  people: {
    born: 'Born {date}',
    placeOfBirth: ' in {place}',
    die: ' and die on {date}',
    images: 'Images',
    knowFor: 'Know for',
    coming: 'Coming',
